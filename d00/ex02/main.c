...
int main(void)
{
	...
	printf("price for the art \'%s\' is %d\n", "Guernica", searchPrice(arts, arts_len(arts), "Guernica"));
	printf("price for the art \'%s\' is %d\n", "Miserere", searchPrice(arts, arts_len(arts), " Miserere"));
	printf("price for the art \'%s\' is %d\n", "jkdhfkjsadhdgf", searchPrice(arts, arts_len(arts), "jkdhfkjsadhdgf"));
	printf("price for the art \'%s\' is %d\n", "”Test your Strength” Showman", searchPrice(arts, arts_len(arts), "”Test your Strength” Showman"));
	printf("price for the art \'%s\' is %d\n", "New York Hot - New York Cold", searchPrice(arts, arts_len(arts), "New York Hot - New York Cold"));
	printf("price for the art \'%s\' is %d\n", "Mona Lisa", searchPrice(arts, arts_len(arts), "Mona Lisa"));
